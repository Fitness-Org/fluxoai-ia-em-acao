const WhatsAppButton = () => {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 w-16 h-16 bg-accent hover:bg-accent-hover text-accent-foreground rounded-full shadow-large flex items-center justify-center transition-all duration-300 hover:scale-110 z-50 group"
